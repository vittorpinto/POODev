...
class DataAnalyzer:
    CHARTS_FOLDER = os.path.join(os.getcwd(), "charts")  # Diretório para salvar gráficos
    ...
    def save_chart(self, column_name):
        """
        Salva gráficos para a coluna especificada.
        """
        # Certifique-se de que o diretório de gráficos existe
        ...
        try:
            ...
            plt.close()  # Fechar o gráfico para evitar o warning
            return chart_path
        except Exception as e:
    ...
    def detect_column_context(self, column_name):
        """
        Detecta o contexto de uma coluna com base no nome.
        """
    ...
    def generate_column_chart(self, column_name):
        """
        Gera gráficos para uma coluna específica.
        """
        try:
            plt.figure()  # Garantir uma nova figura para cada gráfico
    ...
    def generate_descriptive_report(self):
        """
        Gera um relatório descritivo e gráficos para as colunas do conjunto de dados.
        """
